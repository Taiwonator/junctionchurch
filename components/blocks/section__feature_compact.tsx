...
import { PageBlocksSection__Feature_Compact } from '@/tina/__generated__/types';
import { Section, sectionBlockSchemaField } from '../layout/section';

export const FeatureSectionCompact = ({ data }: { data: PageBlocksSection__Feature_Compact }) => {
    return (
